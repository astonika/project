...
public class Test4SpringBoot {
		private static final Logger logger = LoggerFactory.getLogger(Test4SpringBoot.class);
		...
		public static void main(String[] args) throws IOException {
			Test4SpringBoot apolloConfigDemo = new Test4SpringBoot();
